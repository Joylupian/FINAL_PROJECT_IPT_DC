...
<div wire.ignore.self class="modal fade" id="click" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content " id="modall">
        <div class="modal-header bg-black bg-opacity-50 text-start">
            <h5 class="modal-title title1 text-black" id="exampleModalLabel">Create Talk</h5>
...
<div wire:ignore.self class="modal fade" id="click-delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        ...
        <div class="modal-footer">
            <button type="button" id="submit-button" class="btn btn-danger form-control" wire:click="deletePost()">Delete</button>
        </div>
        </div>
    </div>
</div>
...
<div wire:ignore.self class="modal fade" id="click-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content" id="modall">
        <div class="modal-header bg-black bg-opacity-50">
            <h5 class="modal-title title2 text-dark" id="exampleModalLabel">Edit Talk</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        ...
        <div class="modal-footer">
            <button type="button" id="submit-button" class="btn btn-success form-control" wire:click="updatePosts()">Update</button>
        </div>
        </div>
    </div>
</div>
