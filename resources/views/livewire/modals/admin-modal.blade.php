<div>
    ...
    <div wire:ignore.self class="modal fade" id="modal-roles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header bg-black bg-opacity-50">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btn-sm"><span class="fas fa-save"></span> Add</button>
            </div>
            </form>
            </div>
        </div>
...
{{--
                    ...
                    <button type="submit" class="btn btn-success btn-sm"><span class="fas fa-pencil-square-o"></span> Update</button>
                </div>
            </div>
            </form>
            </div>
    ...
    <div wire:ignore.self class="modal fade" id="update-modal-permissions" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <button type="submit" class="btn btn-success btn-sm" wire:click="updatePermissions()"><span class="fas fa-pencil-square-o"></span> Update</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div wire:ignore.self class="modal fade" id="update-modal-users" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <button type="submit" class="btn btn-primary btn-sm"><span class="fas fa-pencil-square-o"></span> Update</button>
                </div>
                </form>
            </div>
        </div>
