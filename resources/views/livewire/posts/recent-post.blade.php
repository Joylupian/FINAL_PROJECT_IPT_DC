<div class="container col-md-12 ">
    ...
    <div class="profile">
        <h2 class="mt-3 text-white text-start mb-5" style="font-weight: 500; font-size: 30px;">Recent Talks</h2>
    </div>
    <div class="post-body">
        ...
        <div class="col-md-4">
            ...
            <div class="col p-3 shadow-sm rounded mb-5 float-start" id="write">
                <input type="text " class="write-2 form-control bg-secondary bg-opacity-25 text-white" placeholder="Search" wire:model.lazy="search">
            </div>
            ...
            <div class="card mt-3 {{ $recent->user->gender === 'Female' ? 'f1' : 'm1' }}" style="width: 900px">
                <div class="card-header bg-black bg-opacity-50">
                    <span class="float-end" id="titlee">
                        <span class="float-end" id="titleee"><strong>{{ $recent->title }}</span></strong>
                        </span>

                        <div>
                        <span class="time text-white" style="position:relative; top: 10px; left: -50px;"><strong>Posted at: {{ $recent->created_at->format('g:i A') }}</strong></span>
                    </div>
                </div>
