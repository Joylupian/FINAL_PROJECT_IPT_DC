<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-start mb-5" style="font-size: 23px; color:#f8f5f5;">{{Auth::user()->name}}'s Profile</h2>
        </div>
        <div class="post-body">
            <div class="col-md-6" style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control bg-secondary bg-opacity-25" data-toggle="modal" data-target="#click">Create new talk</button>
                </div>
            </div>
            ...
            <div class="col-md-10  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    <div class="card-header bg-black bg-opacity-50">
                        @if($post->isEditable())
                        <span id="dot-icon" class="float-end dropdown dropstart bg-warning bg-opacity-50">
                            <span class="fa-solid fa-edit text-light" type="button" data-bs-toggle="dropdown" aria-expanded="false"></span>
                            <ul class="dropdown-menu bg-warning bg-opacity-25">
                        ...
                        <span class="time text-white" style="position:relative; top: 10px; left: -50px;"><strong>{{ $post->created_at->format('g:i A') }}</strong></span>
                    </div>
