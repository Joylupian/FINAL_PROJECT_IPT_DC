...
<body>
    <div class="container col-md-4 offset-md-4">
        ...
        <div class="card shadow mb-5 rounded border border-light mt-5">
            <div class="card-body rounded" style="background-color: #6b7e82;" id="card-bodyy">
                <h2 class="text-center mb-4" style="color:#eef4f5; font-size: 25px;">Log In</h2>
                <form action="{{ '/' }}" method="POST">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-success" id="actionBtn" type="submit">Login</button>
                        </div>
                    </div>
                    </form>
            </div>
