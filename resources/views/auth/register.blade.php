...
<body>
    <div class="container col-sm-4 offset-sm-4">
        ...
        <div class="card shadow mb-5 rounded border border-light mt-5">
            <div class="card-body" style="background-color: #6b7e82;" id="card-bodyy">
                <h2 class='text-center mt-2 mb-4 ' style="color: #eef4f5; font-size: 25px;">Register</h2>
                <form action="{{ '/register' }}" method="POST">
                    ...
                    <div class="form-group mb-3 mt-1 d-flex justify-content-center">
