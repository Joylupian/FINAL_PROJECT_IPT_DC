<nav class="navbar navbar-expand-lg navbar-light shadow bg-secondary bg-opacity-25">

    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span class="fas fa-comments"></span> CheapTalk</h2>
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}"
                    href="{{ '/recent-post' }}">Recent Talks</a>
            </li>
            ...
            @role('admin')
                ...
                <div class="dropdown">
                    <a class="btn dropdown-toggle text-warning bg-primary bg-opacity-25" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="fas fa-shield"></span>
                        Admin
                    </a>
                    <div class="dropdown-menu bg-secondary bg-opacity-25" aria-labelledby="dropdownMenuButton" id="select3">
